...
<item:moonstone:the_heart>.anyDamage().addTooltip("\u00A7c击杀死尸术士或黑暗萨满均有几率获得");
...
<item:moonstone:magicstone>.anyDamage().addTooltip("\u00A72据说“抗性”实际为“易伤”效果");
...
<item:moonstone:bloodvirus>.anyDamage().addTooltip("\u00A72新增击杀末影龙有较低几率获得");
...
<item:moonstone:necora>.anyDamage().addTooltip("\u00A73可制作获得，在礼装章节有任务可增加达琍特存储饰品栏位");
<item:moonstone:necora>.anyDamage().addTooltip("\u00A7c对亡灵生物造成的所有伤害会降低，但能有效降低反射等魔法伤害");
<item:moonstone:necora>.anyDamage().addTooltip("\u00A7e谨慎佩戴！还会在独立乘区降低玩家10%伤害");
...
<item:moonstone:fermentation>.anyDamage().addTooltip("\u00A7e需注意多重伤害（如枪械同时有穿甲和非穿甲伤害）会抢掉加伤效果");
<item:moonstone:fermentation>.anyDamage().addTooltip("\u00A72穿戴后可在界面左下角显示冷却时间");
...
<item:moonstone:air>.anyDamage().addTooltip("\u00A72据说此饰品不在水中时额外增加15%的抗性");
...
<item:moonstone:watergen>.anyDamage().addTooltip("\u00A73据说此饰品没有实际效果");
